...
const sendEmail = (e) =>{
	...
	if(contactName.value === '' || contactEmail.value === '' || contactProject.value === ''){
		...
		emailjs.sendForm('service_u04yz9a','template_v9v3tvq','#contact-form','OmsQrQBfILQg8CYD2').then(() =>{
				// Show message and add color
				contactMessage.classList.add('color-blue');
				contactMessage.textContent = 'Message sent correctly ';

				// Remove message after five seg
				setTimeout(() =>{
